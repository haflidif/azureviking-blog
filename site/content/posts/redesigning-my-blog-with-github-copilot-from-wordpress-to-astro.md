...
![WordPress to Astro migration](/azureviking-blog/images/posts/redesigning-blog-with-copilot/cover.jpg)
...
<video autoplay loop muted playsinline style="width:100%; border-radius:8px; margin:1.5rem 0;">
  <source src="/azureviking-blog/images/posts/redesigning-blog-with-copilot/copilot-start.mp4" type="video/mp4">
</video>

_Starting the Copilot CLI and typing the very first ask that kicked off the entire migration._

What followed was an extraordinary collaboration that spanned **114 commits**, **130+ files changed**, and thousands of lines of code. All through conversation.
...
This migration is just the beginning. The unified content system already supports categories like Tutorial, Lab, News, and Podcast, I just need to create the content. I'm also planning to:

- Migrate the custom domain (azureviking.com) to point to GitHub Pages
